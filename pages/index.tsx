...
import Listings from "../components/images/tsx/Listings";
	...
	return (
		<Layout>
			...
			<Container>
				...
				<Hero />
				<BlurbTwoByTwoGrid id="our-mission" content={gridContent} />
				<Listings />
				<MarketingSplit
					content={{
						...splitContent,
						features: splitContent.features.map((feature) => ({
							...feature,
							icon: feature.icon as
								| "MapIcon"
								| "BuildingLibraryIcon"
								| "PuzzlePieceIcon"
								| "UserGroupIcon",
