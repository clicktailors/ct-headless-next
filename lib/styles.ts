export const styles = {
	...
	hero: {
		...
		buttonSecondary: "btn btn-outline bg-transparent border-2 rounded-lg p-2 border-primary text-primary hover:bg-primary hover:text-white transition-colors duration-300 ease-in-out hover:scale-110",
		image: "rounded-lg",
	},
