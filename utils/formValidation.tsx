import { FieldType } from '../components/ui/Form/Form';

export interface FormErrors {
  [key: string]: string;
}

export const validateForm = (fields: FieldType[] | { [category: string]: FieldType[] }, formData: any): FormErrors => {
  ...
  const validateFields = (fieldsArray: FieldType[]) => {
    fieldsArray.forEach((field) => {
      ...
      } else if (field.type === 'tel' && !isValidPhoneNumber(formData[field.name])) {
